...
SCORE_FONT = pygame.font.SysFont("arial bold", 30)
...
def draw():
    ...
    pygame.draw.rect(dis, red, [SNAKE_BLOCK*(snake[0]%WIDTH), SNAKE_BLOCK*(snake[0]//WIDTH), SNAKE_BLOCK, SNAKE_BLOCK])
    for idx in snake[1:snake_size]:
